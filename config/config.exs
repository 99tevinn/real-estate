...
config :real_estate, RealEstateWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: RealEstateWeb.ErrorHTML, json: RealEstateWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: RealEstate.PubSub,
  live_view: [signing_salt: "RVobxpGP"]
...
config :real_estate, RealEstate.Mailer, adapter: Swoosh.Adapters.Local
